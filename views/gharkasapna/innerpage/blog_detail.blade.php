        ...
        <div class="roww wow fadeInUp" data-wow-delay="500ms">
            <div class="col-xl-8 offset-xl-2">
                ...
                <div class="mbp_pagination_tab bdrb1">
                    <div class="row justify-content-between pt45 pt30-sm pb45 pb30-sm">
                        <div class="col-md-6">
                            <div class="pag_prev">
                                @if ($previousBlog)
                                <a href="{{route('blog.detail', ['name' => Str::slug($previousBlog->blog_name)])}}">
                        ...
                        <div class="col-md-6">
                            <div class="pag_next">
                                @if ($nextBlog)
                                <a href="{{route('blog.detail', ['name' => Str::slug($nextBlog->blog_name)])}}" class="text-end">
                ...
                <div class="bsp_reveiw_wrt">
                    ...
                    <form class="comments_form mt30" action="{{route('manage.blog.comment')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-4">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="blog-style1">
                    ...
                    <div class="blog-content">
                        ...
                        <h6 class="title mt-1"><a href="{{route('blog.detail', ['name' => Str::slug($post->blog_name)])}}">{{ucwords($post->blog_name)}}</a></h6>
                    </div>
                </div>
            </div>
            @endforeach
