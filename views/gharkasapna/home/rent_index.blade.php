...
<section class="home-banner-style4 p0 bgc-white">
    <div class="home-style-rent4 maxw1600 bdrs24 position-relative mx-auto" style="--background-url: url('{{ asset('public/assets/images/home/Rectangle 4516.png') }}')">
        <div class="container">
            <div class="row">
                <div class="col-xl-9">
                        ...
                        <div class=" custom tab">
                            <div class="advance-style3 mb30 mx-auto animate-up-2">
                                <ul class="nav nav-tabs p-0 m-0" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item text-color-light-grey-font" role="presentation">
                                        <a class="nav-link active" href="{{route('newrent.properties')}}">Rent</a>
                                    </li>
                                    <li class="nav-item text-color-light-grey-font" role="presentation">
                                        <!--  -->
                                ...
                                $searchString = 'property-for-rent-';
                                            ...
                                            <div class="col-md-2" id="citySelectContainer">
                                                <div class="input-group custom-city-dropdown">
                                                    <select name="city_name" class="custom-select" id="citySelect" form="property-form">
                                                        ...
                                                        @else
                                                        <option selected disabled>{{ ucwords(str_replace('_', ' ', $city)) }}</option>
                                                        @endif
                                                        @foreach ($cities->pluck('city')->unique() as $data)
                                                        <option value="{{ $data }}">{{ ucwords(str_replace('_', ' ', $data)) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                            ...
                            <div class="img-box-10 position-relative">
                                <div class="listing-style1 mini-style bounce-y">
                                    <div class="list-content">
                                        <h6 class="list-title"><a href="{{ route('single.listing.rent', ['name' => Str::slug($data->property_name)])}}">{{ucfirst($data->property_name)}}</a></h6>
                                        <p class="list-text">{{ ucwords($data['project_society']) }}, {{ ucwords($data['locality']) }}, {{ ucwords($data['city']) }}</p>

                                        <a href="{{ route('single.listing.rent', ['name' => Str::slug($data->property_name)])}}" class="btn mt15 fz15">View House<i class="fal fa-arrow-right-long"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row pt70 pb70">
                <div class="row wow fadeInUp" data-wow-delay="100ms">
                    ...
                    <div class="col-lg-3">
                        <div class="text-start text-lg-end mb-3">
                            @if($city == null)
                            <a class="ud-btn2" target="_blank" href="{{ route('all.listing.rent') }}">See All Properties</a>
                            @else
                            <a class="ud-btn2" target="_blank" href="{{ url('all-properties-rent',['city' => Str::slug($city)]) }}">See All Properties</a>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="listing-style5">
                        ...
                        <div class="list-content">
                            ...
                            <h6 class="list-title"><a class="text-color-black" target="_blank" href="{{ route('single.listing.rent', ['name' => Str::slug($property->property_name)])}}">{{ ucwords($property->property_name) }}</a></h6>
...
<!-- Our CTA -->
<section class="our-cta p-100" style="--background-url: url('{{asset('public/assets/css/images/above-footer-rent.png')}}')">
    <div class="container">
        <div class="row">
    ...
    $(document).ready(function() {
        $("#citySelect").change(function() {
            ...
            if (selectedCity !== 'Select city') {
                ...
                var newUrl = "property-for-rent-" + selectedCity.toLowerCase().replace(/\s/g, '_');
                if (window.location.href.includes('/property-for-rent-/')) {
                    newUrl = newUrl.replace('property-for-rent-/', '');
                }
...
<script>
    $(document).ready(function() {
        ...
        $('#search-address').keyup(function() {
            ...
            var searchString = 'property-for-rent-';
                    ...
                    if (response.length === 0) {
                        ...
                        $.each(response, function(index, property) {
                            ...
                            if(!uniqueOptions.hasOwnProperty(optionText)) {
                                ...
                                var propertyRoute = "{{ url('rent-search') }}/" + encodedProjectSociety;
