...
<section class="breadcumb-section2 p-0"  style="--background-url: url('{{ asset('public/assets/images/about-page-banner.png') }}')">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcumb-style1">
                    <h2 class="text-color-white">About <span class="text-color-orange">Us</span></h2>
        ...
        <div class="row wow fadeInUp" data-wow-delay="300ms">
            <div class="col-lg-12">
                <div class="about-page-img">
                    <img class="w-100" src="{{asset('public/assets/images/about1.png')}}" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row wow fadeInUp" data-wow-delay="300ms">
            <div class="col-auto">
                <div class="feature-style2 mb30">
                    <div class="feature-img"><img class="bdrs12" src="{{asset('public/assets/images/team/agent-1.jpg')}}" alt=""></div>
            ...
            <div class="col-auto">
                <div class="feature-style2 mb30">
                    <div class="feature-img"><img class="bdrs12" src="{{asset('public/assets/images/team/agent-2.jpg')}}" alt=""></div>
                    <div class="feature-content pt20">
            ...
            <div class="col-auto">
                <div class="feature-style2 mb30">
                    <div class="feature-img"><img class="bdrs12" src="{{asset('public/assets/images/team/agent-3.jpg')}}" alt=""></div>
                    <div class="feature-content pt20">
            ...
            <div class="col-auto">
                <div class="feature-style2 mb30">
                    <div class="feature-img"><img class="bdrs12" src="{{asset('public/assets/images/team/agent-4.jpg')}}" alt=""></div>
                    <div class="feature-content pt20">
            ...
            <div class="col-auto">
                <div class="feature-style2 mb30">
                    <div class="feature-img"><img class="bdrs12" src="{{asset('public/assets/images/team/agent-5.jpg')}}" alt=""></div>
                    <div class="feature-content pt20">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="dots_none nav_none slider-dib-sm slider-6-grid owl-carousel owl-theme wow fadeInUp" data-wow-delay="300ms">
                    <div class="item">
                        <div class="partner_item"><img class="wa m-auto" src="{{asset('public/assets/images/amazon-about.png')}}" alt="1.png"></div>
                    </div>
                    <div class="item">
                        <div class="partner_item"><img class="wa m-auto" src="{{asset('public/assets/images/partners/2.png')}}" alt="2.png"></div>
                    </div>
                    <div class="item">
                        <div class="partner_item"><img class="wa m-auto" src="{{asset('public/assets/images/partners/3.png')}}" alt="3.png"></div>
                    </div>
                    <div class="item">
                        <div class="partner_item"><img class="wa m-auto" src="{{asset('public/assets/images/partners/4.png')}}" alt="4.png"></div>
                    </div>
                    <div class="item">
                        <div class="partner_item"><img class="wa m-auto" src="{{asset('public/assets/images/partners/5.png')}}" alt="5.png"></div>
                    </div>
                    <div class="item">
                        <div class="partner_item"><img class="wa m-auto" src="{{asset('public/assets/images/partners/6.png')}}" alt="6.png"></div>
                    </div>
                </div>
            </div>
        </div>
...
<section class="our-cta">
    <div class="cta-banner bgc-f7 mx-auto maxw1600 pt120 pb120 pt60-md pb60-md bdrs12 position-relative mx20-lg">
        ...
        <div class="img-box-6">
            <img class="img-1 spin-left" src="{{asset('public/assets/images/about/element-1.png')}}" alt="">
        </div>
        <div class="container">
