...
<section class="home-banner-style4 p0 bgc-white">
    <div class="home-style-pg maxw1600 bdrs24 position-relative mx-auto" style="--background-url: url('{{ asset('public/assets/images/home/Rectangle 4537.png')}}')">
        <div class="container">
            <div class="row">
                <div class="col-xl-9">
                            ...
                            <div class="advance-style3 mb30 mx-auto animate-up-2">
                                <ul class="nav nav-tabs p-0 m-0" id="myTab" role="tablist">
                                    <li class="nav-item text-color-light-grey-font" role="presentation">
                                        <a class="nav-link" target="_blank" href="{{ route('new.index') }}">Buy</a>
                                    </li>
                                    <li class="nav-item text-color-light-grey-font" role="presentation">
                                        <a class="nav-link " target="_blank" href="{{route('newrent.properties')}}">Rent</a>
                                    </li>
                                    <li class="nav-item text-color-light-grey-font" role="presentation">
                                        <a class="nav-link active" href="{{ route('new.paying.guests') }}">PG/Co living</a>
                                    </li>
        ...
        <div class="container">
                            ...
                            <div class="img-box-10 position-relative">
                                <div class="listing-style1 mini-style bounce-y">
                                    <div class="list-content">
                                        <h6 class="list-title"><a href="{{ route('single.pg.listing', ['name' => Str::slug($data->pg_name)])}}">{{ucfirst($data->pg_name)}}</a></h6>
                                        <p class="list-text">{{ ucwords($data['project_society']) }}, {{ ucwords($data['locality']) }}, {{ ucwords($data['city']) }}</p>

                                        <a href="{{ route('single.pg.listing', ['name' => Str::slug($data->pg_name)])}}" class="btn mt15 fz15">View House<i class="fal fa-arrow-right-long"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row pt70 pb70">
                <div class="row wow fadeInUp" data-wow-delay="100ms">
                    <div class="col-lg-9">
                        <div class="main-title2">
                            <h2 class="title">{{ucwords($propertyTitle)}}</h2>
                    ...
                    <div class="col-lg-3">
                        <div class="text-start text-lg-end mb-3">
                            @if($city == null)
                            <a class="ud-btn2" href="{{route('manage.pg.listing', ['name' => Str::slug('paying-guests')])}}">See All Properties</a>
                            @else
                            <a class="ud-btn2" href="{{url('paying-guests-search', ['name' => Str::slug($city)])}}">See All Properties</a>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="listing-style5">
                        ...
                        <div class="list-content">
                            <div class="list-price mb-2">{{formatRent($data->rent)}} / <span>mo</span></div>
                            <h6 class="list-title"><a class="text-color-black" href="{{route('single.pg.listing', ['name' => Str::slug($data->pg_name)])}}">{{ucwords($data->pg_name)}}</a></h6>
                            <p class="list-text">{{ ucwords($data['project_society']) }}, {{ ucwords($data['locality']) }}, {{ ucwords($data['city']) }}</p>
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        $("#citySelect").change(function() {
            ...
            if (selectedCity !== 'Select city') {
                ...
                var newUrl = "pgs-in-" + selectedCity.toLowerCase().replace(/\s/g, '_');
                if (window.location.href.includes('/pgs-in-/')) {
                    newUrl = newUrl.replace('pgs-in-/', '');
                }
                    ...
                    if (response.length === 0) {
                        ...
                        $.each(response, function(index, property) {
                            ...
                            if (!uniqueOptions.hasOwnProperty(optionText)) {
                                ...
                                var propertyRoute = "{{ url('paying-search') }}/" + encodedProjectSociety;
